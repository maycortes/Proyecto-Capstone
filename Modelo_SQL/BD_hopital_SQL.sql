...
CREATE TABLE IF NOT EXISTS `hospital`.`Encargado` (
  ...
  INDEX `fk_Encargado_Administrativo_idx` (`idAdm` ASC) VISIBLE,
  INDEX `fk_Encargado_Seccion1_idx` (`idSec` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `hospital`.`Registro` (
  ...
  PRIMARY KEY (`idReg`),
  INDEX `fk_Registro_Usuario1_idx` (`idUsu` ASC) VISIBLE,
